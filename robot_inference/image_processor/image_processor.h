...
private:
    ...
    float CreateTopViewMat(const cv::Mat& mat_original, cv::Mat& mat_topview);
    float DrawSegmentation(cv::Mat& mat_segmentation, const SemanticSegmentationEngine::Result& segmentation_result);
